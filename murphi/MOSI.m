...
s_cache: enum { 
  ...
  cache_I_store_GetM_Ack_AD__Fwd_GetM_M_I,
  cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O,
  cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetM_O_I,
  cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O,
  cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetM_O_I,
  cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O,
  cache_I_store__Fwd_GetM_M_I,
  cache_I_store__Fwd_GetS_M_O,
  cache_I_store__Fwd_GetS_M_O__Fwd_GetM_O_I,
  cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O,
  cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetM_O_I,
  cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O,
  cache_M,
  cache_M_evict,
  ...
  cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O,
  cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O,
  cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O,
  cache_O_store__Fwd_GetS_M_O,
  cache_O_store__Fwd_GetS_M_O__Fwd_GetS_O_O,
  cache_O_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O,
  cache_S,
  cache_S_evict
};
...
switch inmsg.mtype
  case Fwd_GetM_M:
    ...
    cle.State := cache_I_store__Fwd_GetM_M_I;
    cle.Perm := none;
  ...
  case Fwd_GetS_M:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store__Fwd_GetS_M_O;
    cle.Perm := none;
...
switch inmsg.mtype
  case Fwd_GetM_M:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store_GetM_Ack_AD__Fwd_GetM_M_I;
    cle.Perm := none;
  ...
  case Fwd_GetS_M:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O;
    cle.Perm := none;
...
case cache_I_store_GetM_Ack_AD__Fwd_GetM_M_I:
switch inmsg.mtype
  case Inv_Ack:
    cle.acksReceived := cle.acksReceived+1;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O:
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
    
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetM_O_I;
    cle.Perm := none;
  ...
  case Fwd_GetS_O:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O;
    cle.Perm := none;
...
case cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetM_O_I:
switch inmsg.mtype
  case Inv_Ack:
    cle.acksReceived := cle.acksReceived+1;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O:
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
    
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetM_O_I;
    cle.Perm := none;
  ...
  case Fwd_GetS_O:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O;
    cle.Perm := none;
...
case cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetM_O_I:
switch inmsg.mtype
  case Inv_Ack:
    cle.acksReceived := cle.acksReceived+1;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_I_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O:
switch inmsg.mtype
  case Inv_Ack:
    cle.acksReceived := cle.acksReceived+1;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_I_store__Fwd_GetM_M_I:
switch inmsg.mtype
  case GetM_Ack_AD:
    cle.acksExpected := inmsg.acksExpected;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_I_store__Fwd_GetS_M_O:
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
    
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store__Fwd_GetS_M_O__Fwd_GetM_O_I;
    cle.Perm := none;
  ...
  case Fwd_GetS_O:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O;
    cle.Perm := none;
...
case cache_I_store__Fwd_GetS_M_O__Fwd_GetM_O_I:
switch inmsg.mtype
  case GetM_Ack_AD:
    cle.acksExpected := inmsg.acksExpected;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O:
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
    
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetM_O_I;
    cle.Perm := none;
  ...
  case Fwd_GetS_O:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O;
    cle.Perm := none;
...
case cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetM_O_I:
switch inmsg.mtype
  case GetM_Ack_AD:
    cle.acksExpected := inmsg.acksExpected;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_I_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O:
switch inmsg.mtype
  case GetM_Ack_AD:
    cle.acksExpected := inmsg.acksExpected;
    if (cle.acksExpected=cle.acksReceived) then
...
switch inmsg.mtype
  ...
  case Fwd_GetS_M:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_O_store__Fwd_GetS_M_O;
    cle.Perm := load;
...
switch inmsg.mtype
  ...
  case Fwd_GetS_M:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O;
    cle.Perm := load;
...
case cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O:
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
  ...
  case Fwd_GetS_O:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O;
    cle.Perm := load;
...
case cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O:
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
  ...
  case Fwd_GetS_O:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O;
    cle.Perm := load;
...
case cache_O_store_GetM_Ack_AD__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O:
switch inmsg.mtype
  case Inv_Ack:
    cle.acksReceived := cle.acksReceived+1;
    if (cle.acksExpected=cle.acksReceived) then
...
case cache_O_store__Fwd_GetS_M_O:
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
  ...
  case Fwd_GetS_O:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_O_store__Fwd_GetS_M_O__Fwd_GetS_O_O;
    cle.Perm := load;
...
case cache_O_store__Fwd_GetS_M_O__Fwd_GetS_O_O:
switch inmsg.mtype
  case Fwd_GetM_O:
    msg := RespDataAck(adr,GetM_Ack_AD,m,inmsg.src,cle.cl,inmsg.acksExpected);
  ...
  case Fwd_GetS_O:
    ...
    i_cache_Defermsg(msg, adr, m);
    cle.State := cache_O_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O;
    cle.Perm := load;
...
case cache_O_store__Fwd_GetS_M_O__Fwd_GetS_O_O__Fwd_GetS_O_O:
switch inmsg.mtype
  case GetM_Ack_AD:
    cle.acksExpected := inmsg.acksExpected;
    if (cle.acksExpected=cle.acksReceived) then
...
begin
  alias cle: i_cache[m].CL[adr] do
    msg := RespData(adr,PutM,m,directory,cle.cl);
    Send_req(msg);
