...
class NonStallingOptimizationPass : public mlir::fsm::NonStallingOptimizationPassBase<NonStallingOptimizationPass>{
public:
  void runOnOperation() override;
};
}

WalkResult handleTransientState(StateOp transientState, PatternRewriter &/*rewriter*/){
...
void NonStallingOptimizationPass::runOnOperation() {
  ...
  auto result = utils::runOnEachTransientState(theCache, rewriter, handleTransientState);
