...
then
  ...
  types=("TypeDecl" "ConstDecl" "MurphiType" "Murphi_json_schema" "TypeDescription" "ProcDef" "ProcDecl" "ExpressionDescription" "StatementDescription" "Designator" "Formal" "Quantifier" "CaseStmt") # add types to be generated here
