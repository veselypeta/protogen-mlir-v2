module  {        %13 = pcc.inl_const #pcc.state_attr<I>
  ...
  pcc.process @cache_I_store(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data>) attributes {action = "store", start_state = "cache_I", state_type = "stable"} {
  ...
  pcc.process @cache_I_load(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data>) attributes {action = "load", start_state = "cache_I", state_type = "stable"} {
    %10 = pcc.struct_access %arg0["ID"] : !pcc.struct<!pcc.state<I>, !pcc.data> -> !pcc.id
    %11 = pcc.struct_access %5["ID"] : !pcc.struct<!pcc.state<I>, !pcc.data, !pcc.id> -> !pcc.id
    %12 = pcc.msg_constr %10 %11 {mtype = !pcc.mtype<GetM>} : !pcc.struct<!pcc.id, !pcc.mtype<none>, !pcc.id>
    pcc.send : %3 : !pcc.network<unordered> %12 : !pcc.struct<!pcc.id, !pcc.mtype<none>, !pcc.id>
  ...
  pcc.process @cache_M_load(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data>) attributes {action = "load", end_state = "M", start_state = "cache_M", state_type = "stable"} {
  }
  pcc.process @cache_M_store(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data>) attributes {action = "store", end_state = "M", start_state = "cache_M", state_type = "stable"} {
  }
  pcc.process @cache_M_Fwd_GetM(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data>, %arg1: !pcc.struct<!pcc.id, !pcc.mtype<none>, !pcc.id>) attributes {action = "Fwd_GetM", end_state = "I", start_state = "cache_M", state_type = "stable"} {
    %10 = pcc.struct_access %arg0["ID"] : !pcc.struct<!pcc.state<I>, !pcc.data> -> !pcc.id
  ...
  pcc.process @cache_M_evict(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data>) attributes {action = "evict", start_state = "cache_M", state_type = "stable"} {
    %10 = pcc.struct_access %arg0["ID"] : !pcc.struct<!pcc.state<I>, !pcc.data> -> !pcc.id
    %11 = pcc.struct_access %5["ID"] : !pcc.struct<!pcc.state<I>, !pcc.data, !pcc.id> -> !pcc.id
  ...
  pcc.process @directory_I_GetM(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data, !pcc.id>, %arg1: !pcc.struct<!pcc.id, !pcc.mtype<none>, !pcc.id>) attributes {action = "GetM", end_state = "M", start_state = "directory_I", state_type = "stable"} {
  ...
  pcc.process @directory_M_GetM(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data, !pcc.id>, %arg1: !pcc.struct<!pcc.id, !pcc.mtype<none>, !pcc.id>) attributes {action = "GetM", end_state = "M", start_state = "directory_M", state_type = "stable"} {
  ...
  pcc.process @directory_M_PutM(%arg0: !pcc.struct<!pcc.state<I>, !pcc.data, !pcc.id>, %arg1: !pcc.struct<!pcc.id, !pcc.mtype<none>, !pcc.id, !pcc.data>) attributes {action = "PutM", start_state = "directory_M", state_type = "stable"} {
    %10 = pcc.struct_access %arg0["ID"] : !pcc.struct<!pcc.state<I>, !pcc.data, !pcc.id> -> !pcc.id
    ...
    pcc.send : %1 : !pcc.network<ordered> %12 : !pcc.struct<!pcc.id, !pcc.mtype<none>, !pcc.id>
    %true = constant true
    %true_0 = constant true
    %13 = pcc.eq : %true : i1 %true_0 : i1 -> i1
    pcc.if %13 {
      %14 = pcc.struct_access %arg1["cl"] : !pcc.struct<!pcc.id, !pcc.mtype<none>, !pcc.id, !pcc.data> -> !pcc.data
      pcc.update [cl] %arg0:!pcc.struct<!pcc.state<I>, !pcc.data, !pcc.id> %14:!pcc.data
      %15 = pcc.inl_const #pcc.state_attr<I>
      pcc.update [State] %arg0:!pcc.struct<!pcc.state<I>, !pcc.data, !pcc.id> %15:!pcc.state<I>
    }
  }
}
